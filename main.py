...
class TrendsAgg(object):
    ...
    def from_dict(source):
        last500_object_list = [Trend.from_dict(trend) for trend in source[u'last500']]
...
def main():
    ...
    if doc_dict:
        ...
        for matched_trend in matchedTrends:
            ...
            elif temp_dic[matched_trend.name] != matched_trend: #previous trend with new articles 
                popped_trend = last500_list.pop(last500_list.index(temp_dic[matched_trend.name]))
        ...
        #print("Last500_list BEFORE repacking for firestore:\n", trends_agg, "\n\n")
